 ...
 * @since AM 5.5.0
 */
public class ParseCookieAuthNodePlugin extends AbstractNodeAmPlugin {
	...
	protected Map<String, Iterable<? extends Class<? extends Node>>> getNodesByVersion() {
		return Collections.singletonMap(ParseCookieAuthNodePlugin.currentVersion, 
				Collections.singletonList(ParseCookieAuthNode.class));
	}
	...
	public String getPluginVersion() {
		return ParseCookieAuthNodePlugin.currentVersion;
	}
}
